...
function cards() {
  ...
  axios__WEBPACK_IMPORTED_MODULE_13__["default"].get('http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector, timerID) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      var messageField = document.createElement('img');
  ...
  function createMessage(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_7__.openModal)('.modal', timerID);
