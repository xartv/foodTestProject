...
function cards() {
	...
	// запрос через axios
	axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('http://localhost:3000/menu')
	.then(data => {
...
window.addEventListener('DOMContentLoaded', () => {
	const timerID = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal' ,timerID), 5000);
	...
	(0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__.timer)('.timer', '2022-10-20');
});
})();
