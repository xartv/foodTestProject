...
function calc() {
  // create calc
  var resultField = document.querySelector('.calculating__result span');
  var sex, activity, height, weight, age;
  ...
  function initActivityClass(parentSelector, activityClass) {
    document.querySelector(parentSelector).querySelectorAll('div').forEach(function (item) {
...
function cards() {
  ...
  var MenuItem = /*#__PURE__*/function () {
    function MenuItem(img, alt, subtitle, descr, price, parentSelector) {
...
function forms(formSelector, timerID) {
  ...
  function createMessage(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_5__.openModal)('.modal', timerID);
    ...
    setTimeout(function () {
      (0,_modal__WEBPACK_IMPORTED_MODULE_5__.closeModal)('.modal');
...
function modal(triggerButtonsSelector, timerID) {
  ...
  var triggerButtons = document.querySelectorAll(triggerButtonsSelector);
  ...
  triggerButtons.forEach(function (item) {
...
function slider(_ref) {
  var sliderContainer = _ref.sliderContainer,
    slide = _ref.slide,
    nextArr = _ref.nextArr,
    prevArr = _ref.prevArr,
    totalField = _ref.totalField,
    currentField = _ref.currentField,
    outerWrapper = _ref.outerWrapper,
    innerWrapper = _ref.innerWrapper;
  // send selectors to func
  // create slider
  var slider = document.querySelector(sliderContainer);
  var slides = document.querySelectorAll(slide);
  var current = document.querySelector(currentField);
  var total = document.querySelector(totalField);
  var prevArrow = document.querySelector(prevArr);
  var nextArrow = document.querySelector(nextArr);
  var outer = document.querySelector(outerWrapper);
  var inner = document.querySelector(innerWrapper);
  var width = window.getComputedStyle(outer).width;
  var offset = 0;
  var currentSlideIndex = 1;
  total.innerHTML = slides.length < 10 ? "0".concat(slides.length) : slides.length;
  ...
  for (var i = 0; i < slides.length; i++) {
    dotsWrapper.innerHTML += "<li class=\"dot\" data-slider=\"".concat(i + 1, "\"></li>");
  }
  ...
  function setCurrentSlideValue() {
    current.innerHTML = slides.length < 10 ? "0".concat(currentSlideIndex) : currentSlideIndex;
  }
...
function timer(timerClass, deadline) {
  ...
  function setTimer(selector, endtime) {
    ...
    function updateTimer() {
      var t = calculateDifferenceOfDate(endtime);
      if (t.t <= 0) {
        clearInterval(timerID);
      }
...
window.addEventListener('DOMContentLoaded', function () {
  var timerID = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', timerID);
  }, 5000);
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_0__.calc)();
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_1__.cards)();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_2__.forms)('form', timerID);
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.modal)('[data-modal]', timerID);
